...
plot(poland_value_log, poland$overall, col = "blue", cex=0.5, xlab = "Logarithmic value of football players" , ylab = "Players' skills (Overall)")
points(germany_value_log, germany$overall, col = "red", cex=0.5)
points(Slovenia_value_log, Slovenia$overall, col = "violet", cex=0.5)
points(england_value_log, england$overall, col = "pink" , cex =0.5)
points(Serbia_value_log, Serbia$overall, col = "orange" , cex =0.5)
points(Turkey_value_log, Turkey$overall, col ="yellow", cex= 0.5)
abline(poland_lm, col = "blue")
abline(germany_lm, col = "red")
abline(Slovenia_lm, col = "violet")
abline(england_lm, col ="pink")
